...
export const ChargebackReportModel= {
  kind: 'Report',
  label: 'Report',
  labelPlural: 'Reports',
...
export const ClusterServiceBrokerModel= {
...
export const ClusterServiceClassModel= {
...
export const ClusterServicePlanModel= {
...
export const ServiceInstanceModel= {
...
export const ServiceBindingModel= {
